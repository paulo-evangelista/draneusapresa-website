  ...
  return (
    <>
      ...
      <div className="w-full flex justify-end">
        <p className="text-white text-7xl font-bold mr-4">MELHOR</p>
      </div>
      <div className="w-full flex justify-end">
        <p className="text-white text-6xl font-thin mr-4">
          da <span className="font-bold text-6xl">VIDA</span>
        </p>
      </div>
      ...
      <div className="flex justify-end">
        <div className="w-1/3 text-center mr-8 mt-4">
          <p className="text-sm text-white font-extralight">
            A doutora que te deixa <span className="font-bold">longe</span> dos{' '}
            <span className="font-bold">médicos</span>
          </p>
        </div>
      </div>
      <div className=" mt-32 pt-40 bg-white"></div>
    </>
  )
}
