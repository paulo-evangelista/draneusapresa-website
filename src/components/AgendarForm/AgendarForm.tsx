      ...
      <div className="rounded-xl shadow-2xl text-left text-white max-w-md bg-mainPink mx-auto">
          ...
          <Select onValueChange={(v) => setSubject(v)}>
            ...
            >
              <SelectGroup>
                ...
                <SelectItem value="Climatério e Menopausa">
                  Climatério e Menopausa
                </SelectItem>
                <SelectItem value="Cirurgia Ginecológica">
                  Cirurgia Ginecológica
                </SelectItem>
                <SelectItem value="Ginecologia Clínica">
                  Ginecologia Clínica
                </SelectItem>
                <SelectItem value="Longevidade Saudável">
                  Longevidade Saudável
                </SelectItem>
                <SelectItem value="Laser Ginecológico">
                  Laser Ginecológico
                </SelectItem>
          ...
          <Select onValueChange={(v) => setPeriod(v)}>
            ...
            >
              <SelectGroup>
                ...
                <SelectItem value="Inicio da tarde">Início da tarde</SelectItem>
        ...
        <div className="mx-auto w-fit pt-8 text-center">
          ...
          <p className="pt-1 px-10 pb-4 text-xs text-gray-100 font-light">
            Vamos entrar em contato via WhatsApp para encontrar o melhor horário
            e marcar sua consulta online 😊
          </p>
        </div>
      </div>
